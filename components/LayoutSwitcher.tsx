  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 px-3 py-1.5 bg-[var(--xibalba-bg-tertiary)] border border-white/10 hover:border-[var(--xibalba-accent)] text-sm font-black uppercase tracking-widest text-[var(--xibalba-text-primary)] hover:text-[var(--xibalba-text-primary)] transition-colors"
                ...
                <button
                  ...
                  className={`w-full text-left px-4 py-2.5 text-sm font-medium transition-colors ${
                    currentLayout?.id === layout.id
                      ...
                      : 'text-[var(--xibalba-text-100)] hover:text-[var(--xibalba-text-primary)] hover:bg-[var(--xibalba-bg-hover)]'
                  }`}
                >
                  <div className="flex items-center justify-between">
                    ...
                    {layout.category === 'default' && (
                      <span className="text-xs px-1.5 py-0.5 bg-[var(--xibalba-accent)]/20 text-[var(--xibalba-accent)] uppercase">
                        Default
                      </span>
                    )}
                  </div>
