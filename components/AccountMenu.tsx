    ...
    <ErrorBoundary>
      <div className="relative">
        ...
        >
          ...
          <span className="text-xs text-[var(--xibalba-text-100)] group-hover:text-[var(--xibalba-text-000)] hidden md:inline">
            {userName}
          </span>
          ...
          <>
            ...
            <div className="absolute top-full right-0 mt-2 w-72 xibalba-panel bg-[var(--xibalba-grey-050)] border border-white/10 rounded-lg shadow-2xl z-[101] overflow-hidden">
              ...
              <div className="p-4 border-b border-white/10">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-[var(--xibalba-text-100)] truncate">
                      {userEmail}
                    </div>
                  </div>
                </div>
                {displaySubscription && (
                  <div className="mt-2 pt-2 border-t border-white/10">
                    <div className="flex items-center justify-between">
                      <span className="text-xs text-[var(--xibalba-text-100)]">Plan</span>
              ...
              <div className="py-2">
                ...
                >
                  <span className="material-symbols-outlined text-lg text-[var(--xibalba-text-100)]">
                    settings
                  </span>
                ...
                <button
                  ...
                  className="w-full text-left px-4 py-2 text-sm xibalba-interactive hover:bg-[var(--xibalba-grey-100)] transition-colors flex items-center gap-3 text-[var(--vectorforge-accent)]"
                >
