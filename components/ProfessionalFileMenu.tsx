...
const ProfessionalFileMenu: React.FC<ProfessionalFileMenuProps> = ({
  ...
  try {
    return (
      <header
        className="xibalba-header professional-file-menu-header"
        ref={headerEl => {
          // #region agent log
          if (headerEl) {
            setTimeout(() => {
              ...
              fetch('http://127.0.0.1:7242/ingest/9192f36e-3223-469d-8e1d-e9ca20bc6049', {
                ...
                body: JSON.stringify({
                  location: 'ProfessionalFileMenu.tsx:548',
                  message: 'File menu header rendered - checking visibility',
                  data: {
      ...
      >
        <div className="flex items-center gap-6 xibalba-header-right">
          ...
          <div className="flex items-center gap-4 pr-6">
            ...
            {/* Product Name Mark - Matches design: "VectorForge Advanced" */}
            <div className="flex flex-col -space-y-0.5">
              <div className="flex items-baseline gap-1.5">
                ...
                <span className="text-[11px] font-medium text-[var(--xibalba-text-200)] tracking-normal normal-case">
                  Advanced
                </span>
              </div>
            </div>
        ...
        <div className="flex items-center gap-6 xibalba-header-right">
          {/* ONLINE Button - Matches design */}
          <button className="header-online-button">
            <span className="header-online-indicator"></span>
            <span>ONLINE</span>
          </button>

          {/* SHARE Button - Matches design */}
          <button className="header-share-button">
            <span className="material-symbols-outlined">share</span>
            <span>SHARE</span>
          </button>

          {/* User Profile Icon - Matches design */}
    ...
    return (
      <div className="professional-file-menu-error">
        ProfessionalFileMenu Error: {String(error)}
      </div>
    );
  }
};
